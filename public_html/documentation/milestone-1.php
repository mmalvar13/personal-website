...
<html lang="en">
	...
	<body>
		<h1>PWP Milestone One</h1>
		<h2>Purpose, Audience, and Goal</h2>
			<ol>
				<li><strong>Purpose:</strong> This project is a professional portfolio and personal website</li>
				<li><strong>Audience:</strong> This website is intended for a professional audience, including potential employers, professional peers, as well as clients for freelance projects</li>
				<li><strong>Goal:</strong> The goal of this site is to present myself as a web developer and display my work for potential employers to see in order to acquire full-time or part-time employment. A secondary goal is to provide a gallery of work for potential freelance clients, to present myself as someone they would want to work with, and to give them a method of contacting me.</li>
			</ol>
		<h3>Persona</h3>
			<p>
