			...
			<main>
				<div class="container make-it-work">
					<div class="row row-flex content-wrap">
						...
						<div class="col-md-8 col-xs-12 col-sm-12"><!--col-sm-pull-4-->
							<div class="curlyfont">
								<h1>Projects</h1>
							</div>
							<div class="row">
...
<!--											<a href="#"><i class="fa fa-fw fa-file-code-o"></i></a>-->
								...
								<figure class="effect-hera">
									...
									<figcaption>
										...
										<p>
											<img src="../images/phpLogo.png" id="php">
											<img src="../images/mysql-logo.png" id="mysql">
											<img src="../images/pythonLogo.png" id="python">
										</p>
										<!--										<p>-->
								...
								<figure class="effect-hera">
									<img src="../images/blackDots.png" alt="img25">
									<figcaption>
										<h2>Frame <span>Works</span></h2>
										<p>
											<img src="../images/angularjs.png" id="angular">
											<img src="../images/bootstrap.png" id="bootstrap">
...
<!--											<a href="#"><i class="fa fa-fw fa-file-code-o"></i></a>-->
						...
						<!--									<tr class="success">-->
						<!--										<th>Languages</th>-->
						<!--										<td>PHP7, HTML5, CSS3, Bootstrap, JavaScript, jQuery, Angular JS, MySQL, Python</td>-->
						<!--									</tr>-->
						<!--									<tr>-->
						<!--										<th>Operating Systems</th>-->
						<!--										<td>WWindows: XP, Vista, 7, 8, 8.1, 10</td>-->
						<!--									</tr>-->
						<!--									<tr class="success">-->
						<!--										<th>Software</th>-->
						<!--										<td>Microsoft Office, Google Drive, Google Chrome, Mozilla Firefox, GitHub, Dropbox,-->
						<!--											Encryptr Password Manager, Voter Activation Network Database, Salsa Fundraising-->
						<!--											Software-->
						<!--										</td>-->
						<!--									</tr>-->
						<!--									<tr>-->
						<!--										<th>Troubleshooting</th>-->
						<!--										<td>Troubleshooting Diagnosis of laptops, printers, and network connections</td>-->
						<!--									</tr>-->
						<!--									<tr class="success">-->
						<!--										<th>Other skills</th>-->
						<!--										<td>2 years of experience managing small teams, System administration: command line and-->
						<!--											terminal scripting-->
						<!--										</td>-->
						<!--									</tr>-->
						<!--								</tbody>-->
